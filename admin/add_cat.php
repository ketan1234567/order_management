        ...
        <div class="col-sm-5 ">
          ...
          <div class="box box-warning">
            <div class="box-header with-border ">
              <h3 class="box-title"> Add New Category  Restautrant </h3>
            </div>
            <br>
            <!-- /.box-header -->
            <div class="box-body">
              <form  action="add_cat.php" method="POST"role="form">
                <!-- text input -->
                <!-- <div class="row">
                  <div class="col-sm-6">
              ...
              <table class="table table-bordered ">
                <tr style="background-color:lightblue;">
                  ...
                  <th>Delete</th>
                    ...
                    <?php
                  $sr=1;
                  $res=mysqli_query($connect,"select * from category");
                  while($row=mysqli_fetch_row($res))
                  {
                    $cat=mysqli_query($connect,"select * from category where CATEGORY_ID='".$row[0]."'");
                   ...
                   '<tr>
                      ...
                      <td>'.$cat1[1].'</td>
                      <td>
                      <a href="update_category.php?id='.$row[0].'"> <center> <button class="btn btn-primary btn-flat">
                          <i class="fa fa-pencil-square-o "></i>
                        </button></center></a>
                      </td>
                      <td>
                       <a href="delete_cat.php?id='.$row[0].'"><center> <button class="btn btn-danger btn-flat">
...
if(isset($_POST['ok']))
 {
  $name=$_POST['name'];
if(mysqli_query($connect,"insert into Category(name) values('".$name."')"))
  {
    echo'
    <script>
    alert("Data added");
