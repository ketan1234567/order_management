...
if(mysqli_query($connect,"insert into  subcategorytbl(CATEGORY_ID,name,full_price,half_price) values('".$CATEGORY_ID."','".$name."','".$full_price."','".$half_price."')"))
  {
    echo'
    <script>
    alert("Data added");
        ...
        <div class="col-sm-5">
          <div class="box box-warning">
            <div class="box-header with-border btn btn-primary">
              <h3 class="box-title" style="margin-left: 20px; ">Food sub Menu and price </h3>
            </div>
            <br>
            <!-- /.box-header -->
            <div class="box-body">
              <form  action="add_sub.php" method="POST"role="form">
                <!-- text input -->
                <!-- <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                       ...
                       Select categories <option> Select categories</option>
                        <?php
                     ...
                     <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-5">Full Plate Price</label>
                          <div class="col-sm-7">
                          <input type="text" name="full_price" class="form-control" placeholder="Full Price">
                     ...
                     <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-5">Half Plate</label>
                          <div class="col-sm-7">
                        <input type="text" name="half_price" class="form-control" placeholder="Half price">
                      </div>
                    </div>
                  </div>
              ...
              <table class="table table-bordered ">
                <tr style="background-color:lightblue;">
                  ...
                  <th>Delete</th>
                    ...
                    <?php
                  $sr=1;
                  $res=mysqli_query($connect,"select * from subcategorytbl");
                  while($row=mysqli_fetch_row($res))
                  {
                    $cat=mysqli_query($connect,"select * from subcategorytbl where Subcategory_id='".$row[0]."'");
                   ...
                   '<tr>
                      ...
                      <td>'.$row[2].'</td>
                       ...
                       <td>'.$row[4].'</td>
                      <td>
                      <a href="update_subcategory.php?id='.$row[0].'"> <center> <button class="btn btn-primary btn-flat">
                          <i class="fa fa-pencil-square-o "></i>
                        </button></center></a>
                      </td>
                      <td>
                       <a href="delete_subcat.php?id='.$row[0].'"><center> <button class="btn btn-danger btn-flat">
