...
<div class="wrapper">
  ...
  <div class="row">
    <div class="col-sm-8">
     <div class="form-group  " >
                    <div class="col-sm-2">
                  <button type="submit"  name="order_id" class="btn btn-success ">Order_id</button>
                  </div>
                       <div class="col-sm-4">
                     <input type="text" name="mobile_no" class="form-control" placeholder="Enter ...">

                      </div>   
                      <div class="col-sm-2">
                      <button type="submit"  name="save" class="btn btn-info ">Search</button>
                   ...
                   <br>
                   <div class="form-group " >
                  <label  class="col-sm-2 control-label">Table_No</label>
            ...
            <!-- /.box-header -->
              ...
              <table class="table table-bordered">
                ...
                ?>
                           ...
                           <input type="text" class="col-sm-2 pull-right mt-5" name="mobile_no" class="form-control" placeholder="Total ..." style=" width: 85px;">
                 </div>          
          </div>
  ...
  <div class="row">
    <div class="col-sm-5">
      <button type="submit"  name="save" class="btn btn-success  ">PrintBill</button>
      <button type="submit"  name="save" class="btn btn-info   ">Billpayment</button>
      <button type="submit"  name="save" class="btn btn-danger  ">Add to Invoice</button>
