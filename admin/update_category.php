...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
       $did=$_GET['id'];
      $res=mysqli_query($connect,"select * from category where CATEGORY_ID='".$did."'");
      ...
      <div class="row">
        ...
        <div class="col-sm-5">
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form  action="update_category.php?id=<?php echo $did?>" method="POST"role="form">
                <!-- text input -->
                <!-- <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label> Name </label>
                      <input type="text" class="form-control" value="<?php echo $row[1]?>"  name="sname" placeholder="Enter ...">
  ...
  <footer class="main-footer" style="background-color:#4B515D;   color:white;">
    ...
    <strong>Copyright &copy; 2019 <a href="#">Created By</a>.</strong> Deshmukh Ketan & Surwase Ashwini
  </footer>
...
if(isset($_POST['save']))
 {
  $sname=$_POST['sname'];
  $did=$_POST['did'];
 if(mysqli_query($connect,"update category set name='".$sname."' where CATEGORY_ID='".$did."'"))
  {
    echo'
    <script>
    alert("update added");
