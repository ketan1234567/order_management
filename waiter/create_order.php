...
<head>
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=0.75, user-scalable=no" name="viewport">
  <!-- Bootstrap 3.3.7 -->
            ...
            <div class="box-body">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                     <input type="text" name="country" id="country" class="form-control" placeholder="items">
