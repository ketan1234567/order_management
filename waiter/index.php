...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><h1 style="color: white;"></h1></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style= "color: white;"><b ></span>
    </a>
 ...
 <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-text" style="font-weight:bold;"><h3>Category
                  <?php
              $con= mysqli_connect("localhost","root","","hotel restautrant_db");
              $cat=mysqli_query($con,"select * from category");
              $cat1=mysqli_num_rows($cat);
              echo '
              <h5 style="text-align:center";>'.$cat1.'</h5>
         ...
         <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-red"><i class="fa fa-google-plus"></i></span>
              ...
              <span class="info-box-text" style="font-weight:bold;"><h3>SubCategory
                  <?php
              $con= mysqli_connect("localhost","root","","hotel restautrant_db");
              $cat=mysqli_query($con,"select * from subcategorytbl");
              $cat1=mysqli_num_rows($cat);
              echo '
              <h5 style="text-align:center";>'.$cat1.'</h5>
