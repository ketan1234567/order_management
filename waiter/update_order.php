...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
       $did=$_GET['id'];
      $res=mysqli_query($con,"select * from  create_order where 
         order_id ='".$did."'");
      ...
      <div class="row">
        ...
        <div class="col-sm-7">
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" action="update_order.php?id=<?php echo $did?>" role="form" method="POST">
              <div class="box-body">
                  ...
                  <div class="col-sm-4">
                      <select class="form-control" name="plate"> <?php echo$row['8']?>
                  ...
                  <div class="col-sm-4">
                 <input type="number" name="qty" class="form-control"value="<?php echo $row['9']?>"
...
`
              ...
              <div class="box-footer">
                ...
                <button type="submit"  name="save" class="btn btn-info  col-sm-4" style="width: 100px; height: 40px; margin-left: 230px">Update</button>
              </div>
            </div>
   ...
   $category=$_POST['category'];
    $item=$_POST['item']; 
     ...
     $qty=$_POST['qty']; 
      $price=$_POST['price']; 
  $did=$_POST['did'];
 if(mysqli_query($con,"update create_order set  category='".$category."',item='".$item."',
  plate='".$plate."',qty='".$qty."',price='".$price."'
  where order_id ='".$did."'"))
  {
    echo'
    <script>
